...
> This post is undergoing radical re-formatting due to new theme and is
> not yet complete. Please bear with me.
{: .prompt-warning }
...
| ----------- | ------------------------ | -------------------------------------- |
| `>`         | _Move Forward_           | Moves the tape head forward one cell.  |
| `<`         | _Move Backward_          | Moves the tape head backward one cell. |
| `+`         | _Increment_              | Increment the current cell by 1.       |
| `-`         | _Decrement_              | Decrement the current cell by 1.       |
| `.`         | _Write_                  | Write the current cell as a character  |
| `,`         | _Read_                   | Read one character into current cell   |
| `[`         | _Test and Jump Forward_  |
| `]`         | _Test and Jump Backward_ |


I want to provide a little more detail about some of the intructions


- <code>></code> Moves the tape head forward one cell. So if the tape head prior to execution is at position $$n$$ of the tape then the tape head after execution will be at position $$n+1$$.
- `<`    Move the tape head backward
...
<table style="table-layout: fixed; width: 100%">
  ...
  <tr>
    ...
    <td style="word-wrap: break-word">
            Moves the tape head forward one cell. So if the tape head prior to execution is at position $$n$$ of the tape then the tape head after execution will be at position $$n+1$$.
      <br />
    </td>
  </tr>
            ...
            <tr>
              ...
              <td>
                Moves the tape head backward one cell. So if the tape head prior to execution is at position <div>$$ n $$</div> of the tape then the tape head after execution will be at position $$n-1$$.<br /> </tr>
